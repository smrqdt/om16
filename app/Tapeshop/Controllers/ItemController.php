...
class ItemController extends Controller
{
     ...
     * Edit an item.
     * @param int $id
     * @internal param \Tapeshop\Controllers\POST $_FILES ['image']
     * @internal param \Tapeshop\Controllers\name $POST
     * @internal param \Tapeshop\Controllers\price $POST
     * @internal param \Tapeshop\Controllers\shipping $POST
     * @internal param \Tapeshop\Controllers\description $POST
     * @internal param \Tapeshop\Controllers\ticketscript $POST
     */
