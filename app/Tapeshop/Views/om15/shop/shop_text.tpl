...
<p>Wir haben auch dieses Jahr ein <strong>Early-Bird-Kontingent</strong> für die ersten Bestellungen. Wenn weg, dann weg, also schnell zugreifen!</p>

<p>Da die openmind von neuen Impulsen lebt, gibt es auch ein reserviertes Kontingent für Leute, die noch nie dabei waren. Einfach unten ein Ticket mit dem Zusatz <strong>›meine erste openmind‹</strong> auswählen. Kostet das selbe, hat keine versteckten Features.</p>

<p>Wir freuen uns über alle, die ein <strong>Support-Ticket</strong> kaufen: Die sind teurer als normale (wie sehr, kannst du selbst festlegen); das dadurch zusätzlich eingenommene Geld verwenden wir für Sozialtickets und unser Referent*innen-Budget.</p>
